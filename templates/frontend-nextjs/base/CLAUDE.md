# CLAUDE.md — Frontend (`__PACKAGE_SCOPE__/web`)

This file provides guidance to Claude Code when working in this package.

## Project Overview

Next.js 15 frontend with App Router, TanStack Query, Tailwind CSS, and shadcn/ui. Part of the `__PROJECT_NAME__` monorepo.
...
```bash
pnpm dev          # Start dev server on http://localhost:__WEB_PORT__
...
```typescript
import type { User, CreateUser } from '__PACKAGE_SCOPE__/shared';
import { UserSchema } from '__PACKAGE_SCOPE__/shared';
```
